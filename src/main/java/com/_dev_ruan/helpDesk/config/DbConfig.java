...
public class DbConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
        ...
        Tecnico tec1 = new Tecnico(null, "Maria Souza", "12345678901", "maria@helpdesk.com", "encript");
        
        
        Tecnico tec2 = new Tecnico(null, "Mara Souza", "12345478901", "maria@heldesk.com", "12");
